...
def test_connection(host: str, keyfile: str, user: str = "gcpfire") -> Union[List[bytes], int]:
...
def ssh_copy_file(host: str, filepath: str, keyfile: str, user: str = "gcpfire") -> Union[List[bytes], int]:
...
def invoke_line(cmd: List[str]) -> Union[List[bytes], int]:
